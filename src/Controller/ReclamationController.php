...
class ReclamationController extends AbstractController
{
    ...
    #[Route('/show_reclamtion/{idRec}', name: 'app_reclamation_show', methods: ['GET'])]

    public function show($idRec,ReclamationRepository $reclamationRepository): Response
    {
    ...
    public function edit(Request $request, $idRec, EntityManagerInterface $entityManager,ReclamationRepository $reclamationRepository): Response
    {   $reclamation=$reclamationRepository->find($idRec);
        $form = $this->createForm(ReclamationType::class, $reclamation);
        $form->handleRequest($request);
    ...
    public function searchAction(Request $request,ReclamationRepository $reclamationRepository)
    {
      //  dd($request->query->all());
        ...
        $reclamations =  $reclamationRepository->findEntitiesByString("$requestString");
